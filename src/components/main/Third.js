    ...
    <Second.Container bgColor="#FFFFFF">
      ...
      <_.BoxContainer>
        <_.Box>
          ...
          <_.Text>
            입학전형시스템에 로그인 하시면 학교 홈페이지에 접속할 필요 없이 다가오는 일정을 손쉽게 확인하실 수 있습니다.
          </_.Text>
        </_.Box>
        <_.Box>
          <EyeIcon />
          ...
          <_.Text>
            학생들의 의견을 수렴하여 구성된 사용자 친화적 UI를 제공하므로 원서 제출 및 전형료 납부를 쉽고 간편하게
            진행할 수 있습니다.
          </_.Text>
        </_.Box>
        <_.Box>
          ...
          <_.Text>
            해외 IP 차단, DDOS 대응 등 보안성 강화에 총력을 다해 여러분께 안정적으로 서비스를 제공할 수 있도록
            노력하겠습니다.
          </_.Text>
        </_.Box>
      </_.BoxContainer>
...
function CalendarIcon() {
  return (
    <svg width="50" height="100" viewBox="0 0 50 50" fill="none" xmlns="http://www.w3.org/2000/svg">
