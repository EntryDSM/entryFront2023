    ...
    <_.HistoryContainer>
      ...
      <_.Cards>
        <Card
          ...
          year="2016"
          page="1"
          content="초대 교장선생님이신 최부영 선생님의 권유로 시작된 EntryDSM은 2016년 V1을 출시하여 학생들이 프로덕션 환경의 시스템을 구현하고 운영하는 데 있어 전반적인 기반을 다졌습니다."
        ></Card>
        <Card
          imageUrl={second}
          year="2017"
        ...
        <Card
          ...
          year="2022"
          page="7"
          content="암흑기 같았던 2021년의 Entry DSM 입학전형 시스템이 2022년 새로운 디자인과 새로운 인원으로 돌아왔습니다."
        ></Card>
      </_.Cards>
    </_.HistoryContainer>
  );
